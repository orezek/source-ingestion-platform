...
const envSchema = z.object({
  ...
  CONTROL_PLANE_GCP_PUBSUB_TOPIC: z.string().default('omnicrawl-control-plane-events'),
  CONTROL_PLANE_GCP_PUBSUB_SUBSCRIPTION_PREFIX: z.string().default('omnicrawl-control-plane-run'),
